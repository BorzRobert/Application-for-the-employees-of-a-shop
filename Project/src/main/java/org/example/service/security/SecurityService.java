...
public class SecurityService {
    ...
    public Notification<User> register(String username, String password, String address, boolean staff) {
        Role userRole;
        if (staff)
            userRole = roleRepository.findRoleByTitle(ERole.CASHIER);
        else
            userRole = roleRepository.findRoleByTitle(ERole.FIDELITY_USER);
